...
open class OpenAPIClientAPI {
	public static var basePath = CFConstants.Server.baseUrl //"http://34.82.119.242/api/1.0"
	public static var streamPath = CFConstants.Server.streamUrl //"http://34.82.119.242/api/1.0"
