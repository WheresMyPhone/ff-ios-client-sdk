...
class JSONDataEncodingTest: XCTestCase {
    ...
    func testEncodingParametersNil() {
        let dict = JSONDataEncoding.encodingParameters(jsonData: nil)
        XCTAssertNil(dict)
    }
    func testEncodingParamsEmptyValue() {
        let dict = JSONDataEncoding.encodingParameters(jsonData: Data())
        XCTAssertNil(dict)
    }
    
    func testEncodingParamsWrongKey() {
